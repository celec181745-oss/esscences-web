...
export const velas = [
  // Velas con Buda
  {
    id: 1,
    nombre: "Buddha",
    descripcion: "Vela con diseño de Buda. Perfecta para crear un ambiente de paz.",
    precio: 2999,
    imagen: Buddha
  },
  {
    id: 2,
    nombre: "Small Buddha",
    descripcion: "Ideal para espacios pequeños y crear un ambiente sereno.",
    precio: 1999,
    imagen: SmallBuddha
  },
  ...
  // Velas con Animales
  {
    id: 4,
    nombre: "Bear",
    descripcion: "Adorable vela con diseño de oso. Perfecto para regalar, decorar tu fiesta o una habitación infantil.",
    precio: 1999,
    imagen: Bear
  },
  {
  ...
  },
  {
    id: 8,
    nombre: "Butterfly",
    descripcion: "Vela con diseño de mariposa. Añade un toque delicado y natural en tu espacio.",
    precio: 999,
    imagen: Butterfly2
  },
  {
  ...
  },
  {
    id: 10,
    nombre: "Lion",
    descripcion: "Vela con diseño de león. Perfecta para regalar o decorar una habitación infantil.",
    precio: 1499,
    imagen: Lion
  },
  {
  ...
  // Velas con Flores
  {
    id: 12,
    nombre: "Margarita",
    descripcion: "Delicada vela con diseño de margarita. Perfecta para espacios frescos y naturales.",
    precio: 1499,
    imagen: Margarita
  },
  {
  ...
  {
    id: 21,
    nombre: "Peonia & Base de Madera",
    descripcion: "Vela en forma de peonia y base de madera.",
    precio: 3999,
  ...
  },
  {
    id: 25,
    nombre: "Mini Globe",
    descripcion: "Pequeña vela en forma de cubo, versión pequeña de Globe. Perfecta para decorar espacios pequeños.",
    precio: 1999,
    imagen: MiniGlobe
  },
  ...
  // Velas Temáticas
  {
    id: 27,
    nombre: "Pino",
    descripcion: "Vela en forma de pino. Perfecta para decorar en las fiestas.",
    precio: 3499,
    imagen: ArbolNavidad
  },
  {
  ...
  },
  {
    id: 31,
    nombre: "Cloud",
    descripcion: "Mini vela en forma de nube. Perfecta para regalo o decoración infantil.",
    precio: 999,
    imagen: Cloud
  },
  {
  ...
  },
  {
    ...
    descripcion: "Vela en forma de galleta. Perfecta para la temporada navideña o regalo infantil.",
    precio: 2499,
  ...
  },
  {
    id: 36,
    nombre: "Árbol",
    descripcion: "Vela en forma de pino. Ideal para decorar tu espacio.",
    precio: 2499,
    imagen: Pino
  },
  {
  ...
  },
  {
    id: 38,
    nombre: "Row Hearts",
    descripcion: "Columna de vela en forma de corazones. Perfecta para ocasiones románticas.",
    precio: 1499,
    imagen: RowHearts
  },
  ...
  // Velas con Tarjetón
  {
    ...
    descripcion: "Vela con tarjetón personalizable. Ideal para regalos y ocasiones especiales.",
    precio: 2999,
    imagen: VelaTarjeton
  },
  ...
  {
    id: 43,
    nombre: "Velón Classic",
    descripcion: "Velón clásico. Diseño tradicional y elegancia para tu hogar.",
    precio: 4499,
    imagen: VelonClassic
  },
  {
